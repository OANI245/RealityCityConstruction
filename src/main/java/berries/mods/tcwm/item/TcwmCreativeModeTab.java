...
public class TcwmCreativeModeTab {
    public static final MVCreativeModeTab ITEMS = new MVCreativeModeTab(MVIdentifier.get("tcwm", "core"), () -> new ItemStack(() -> Blocks.LOGO_BLOCK.get().asItem()), (net.minecraft.world.item.CreativeModeTab.DisplayItemsGenerator) (c, e) -> {
