...
public abstract class MVBlockEntityRenderer<T extends MVBlockEntity, S extends MVBlockEntityRenderer.State> implements BlockEntityRenderer<T, S> {
    ...
    @Override
    public void submit(S state, PoseStack poseStack, SubmitNodeCollector submitNodeCollector, net.minecraft.client.renderer.state.level.CameraRenderState camera) {
        fMVRender(state, poseStack, submitNodeCollector, camera);
    }
